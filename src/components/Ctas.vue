...
.ctas .cta a:before{content: ''; position: absolute; left: 0; bottom: 0; display: block; background: rgb(0,0,0); background: linear-gradient(180deg, rgba(0,0,0,0) 60%, rgba(0,0,0,1) 100%); width:100%; height: 100%;}
